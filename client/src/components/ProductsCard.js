  ...
  return (
    <div className="group relative">
      <div
        ...
        className="w-full h-96 cursor-pointer overfolw-hidden"
      >
        <img
      ...
      <div className="w-full border-[1px] px-2 py-4">
        <div className="flex justify-between icon-center">
          <div>
          ...
          <div className="flex justify-end gap-2 relative overflow-hidden w-28 text-sm">
            <div className="flex gap-2 trnasform group-hover:translate-x-24 transition-transform duration-500">
